...
Live: **https://baditaflorin.github.io/mesh-orientation-mosaic/**

Source: **https://github.com/baditaflorin/mesh-orientation-mosaic**
...
git clone https://github.com/baditaflorin/mesh-orientation-mosaic
cd mesh-orientation-mosaic
npm install
npm run dev
```
...
- `mesh-orientation-mosaic:signalingUrl`
- `mesh-orientation-mosaic:turnTokenUrl`
- `mesh-orientation-mosaic:iceServers`
- `mesh-orientation-mosaic:room`
